                    ...
                    Stack(
                      children: [
                        MultiCircularSlider(
                          ...
                          values: [(sumOfSubs/outcomeValue), (sumOfBills/outcomeValue), (sumOfOthers/outcomeValue)],
                          colors: [Color(0xFFFD1960), Color(0xFF29D3E8), Color(0xFF18C737)],
                                ...
                                child: Row(
                                  children: [
                                    CircularPercentIndicator(
                                      ...
                                      progressColor: Color(0xFFFD1960),
                                    ),
                                    SizedBox(width: 10),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                child: Row(
                                  children: [
                                    CircularPercentIndicator(
                                      ...
                                      progressColor: Color(0xFF29D3E8),
                                    ),
                                    SizedBox(width: 10),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                child: Row(
                                  children: [
                                    CircularPercentIndicator(
                                      ...
                                      progressColor: Color(0xFF18C737),
                                    ),
                                    SizedBox(width: 10),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
